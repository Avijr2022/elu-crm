...
| PF-007…011 | **PF-007 Business Unit Management — RELEASED; human decision `PF-007 RELEASE APPROVED: YES`** | `Phase-2-PF007` (annotated) — tag object `bde87e9ee31d2f4c9a25ffdd7169cc9f90607a68` → target `80ae94e1dd071f62198571a7592cf81246ee591e` | PF-007 backend scope only; Batch 1 merged via PR #26 (merge `d752eb7bba535b56377ed2e66240de28dd47db9a`); merge governance reconciled via PR #27 (merge `80ae94e1dd071f62198571a7592cf81246ee591e`); deferred: Flutter UI, project/opportunity/invoice → Business Unit linkage, reporting engine, Business Unit history API; remaining modules per BFS/RDM order. |
